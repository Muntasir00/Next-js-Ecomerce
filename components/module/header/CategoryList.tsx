...
export default function CategoryList({
  ...
  const filterProducts: TypeProductModel[] = [];
  return (
    <div
      className={cn(
          ...
          >
            ...
            {item.subCategory.length > 0 && (
              <>
                ...
                />
                <div className='hidden group-hover:grid absolute h-full lg:w-[740px] xl:w-[868px] bg-white shadow-xl border  top-0 left-[250px] p-5 grid-cols-[100px_1fr_1fr] xl:grid-cols-[164px_1fr_1fr]  gap-5'>
                  <div className=''>
                    <ul>
                  ...
                  {campaigns.length > 0 ? (
                    ...
                    <div className="border bg-[url('/images/banner_subcategory.svg')] bg-cover bg-center bg-no-repeat"></div>
                  )}
                </div>
              </>
            )}
